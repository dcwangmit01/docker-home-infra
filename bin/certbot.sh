...
docker run --rm \
       -v /docker-home-infra/volumes/letsencrypt/etc/letsencrypt:/etc/letsencrypt \
       -v /docker-home-infra/volumes/letsencrypt/var/lib/letsencrypt:/var/lib/letsencrypt \
       -v /docker-home-infra/volumes/letsencrypt/var/log/letsencrypt:/var/log/letsencrypt \
       -v /docker-home-infra/volumes/nginx/web:/var/www \
       deliverous/certbot \
       certonly \
